...
const environmentVariables = z
  .object({
    ...
    LOCK_ENABLED: z.stringbool().default(true),
    LOCK_DIRECTORY_PATH: z.string().optional(),
    LOCK_STALE_AFTER_SECONDS: z
      .string()
      .transform((s) => parseInt(s, 10))
      .default(0),
  ...
  .transform((environment) => ({
    ...environment,
    LOCK_DIRECTORY_PATH:
      environment.LOCK_DIRECTORY_PATH ?? join(environment.SOURCE_DIRECTORY_PATH, ".locks"),
  }));
